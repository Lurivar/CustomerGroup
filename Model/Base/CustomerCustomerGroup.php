...
abstract class CustomerCustomerGroup implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerGroup\\Model\\Map\\CustomerCustomerGroupTableMap';
    ...
    /**
     * Initializes internal state of CustomerGroup\Model\Base\CustomerCustomerGroup object.
     */
    ...
    /**
     * Compares this with another <code>CustomerCustomerGroup</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomerCustomerGroup</code>, delegates to
     * <code>equals(CustomerCustomerGroup)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomerCustomerGroup The current object, for fluid interface
     */
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomerCustomerGroupQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CustomerCustomerGroup::setDeleted()
     * @see CustomerCustomerGroup::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomerCustomerGroupQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomerCustomerGroupTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = CustomerCustomerGroupTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setCustomerGroupId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCustomerId()) && (null === $this->getCustomerGroupId());
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerGroup\Model\CustomerCustomerGroup Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCustomerGroup(ConnectionInterface $con = null)
    {
        if ($this->aCustomerGroup === null && ($this->customer_group_id !== null)) {
            $this->aCustomerGroup = ChildCustomerGroupQuery::create()->findPk($this->customer_group_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCustomerGroup->addCustomerCustomerGroups($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CustomerCustomerGroupTableMap::DEFAULT_STRING_FORMAT);
    }
